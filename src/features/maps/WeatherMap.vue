    ...
    <div class="glass-card p-6 animate-fade-in">
        ...
        <div class="relative h-96 bg-white/5 rounded-lg overflow-hidden">
            ...
            >
                <div class="relative">
                    <div
                        class="w-8 h-8 bg-white/80 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/40 shadow-lg"
                    >
                    ...
                    <div
                        class="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-white/80 rotate-45 border-r border-b border-white/40"
                    ></div>
                </div>
            </div>
