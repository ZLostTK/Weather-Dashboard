          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="relative">
              <img 
                ...
                class="w-12 h-12"
              />
              <div class="absolute -top-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center" v-if="day.day.daily_chance_of_rain > 70">
        ...
        >
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div class="bg-white/5 rounded-lg p-3 text-center">
              ...
              <div class="text-white text-sm font-medium">{{ day.day.totalprecip_mm }}mm</div>
              <div class="text-white/60 text-xs">Precipitation</div>
            </div>
            <div class="bg-white/5 rounded-lg p-3 text-center">
              <Eye class="w-4 h-4 text-gray-400 mx-auto mb-1" />
              <div class="text-white text-sm font-medium">{{ Math.round(day.day.avghumidity) }}%</div>
            ...
            <div class="bg-white/5 rounded-lg p-3 text-center">
              ...
              <div class="text-white text-sm font-medium">{{ day.astro.sunrise }}</div>
...
import { ref } from 'vue';
import { 
  Droplets, Wind, Eye, Sun, Sunrise, ChevronUp, ChevronDown, ChevronRight 
