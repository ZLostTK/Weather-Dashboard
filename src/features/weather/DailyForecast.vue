    ...
    <div class="glass-card p-4 sm:p-6 animate-slide-up">
        <div class="flex flex-col gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <h3 class="text-lg sm:text-xl font-semibold text-white">Pronóstico del Tiempo</h3>
            ...
            <button
                ...
                class="text-white/70 hover:text-white transition-colors text-xs sm:text-sm flex items-center justify-center sm:justify-start space-x-1 w-full sm:w-auto"
            >
        ...
        <div v-if="selectedPeriod === 'hourly'" class="space-y-2 sm:space-y-3">
            <div
                ...
                :class="[
                    ...
                    selectedHour === index ? 'ring-2 ring-white/30 bg-white/15' : '',
                ]"
                @click="toggleHourDetails(index)"
            >
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="flex items-center space-x-2 sm:space-x-4">
                        <div class="text-white font-medium w-16 sm:w-20 text-sm sm:text-base">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="text-white/60 text-xs sm:text-sm flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 mt-1">
                                <span
                    ...
                    <div class="flex items-center justify-center sm:justify-end space-x-2 sm:space-x-4 w-full sm:w-auto">
                        <div class="text-right">
                            ...
                            <div class="text-white/60 text-xs sm:text-sm">{{ Math.round(hour.feelslike_c) }}°</div>
                        </div>

                        <!-- Enhanced temperature bar -->
                        <div class="relative w-20 sm:w-24 h-2.5 sm:h-3 bg-white/20 rounded-full overflow-hidden">
                            <div
                        ...
                        <ChevronRight
                            :class="[
                                'w-3.5 h-3.5 sm:w-4 sm:h-4 text-white/60 transition-transform duration-200',
                ...
                >
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div class="bg-white/5 rounded-lg p-3 text-center">
                            ...
                            <div class="text-white/60 text-xs">Lluvia</div>
                        </div>
                        <div class="bg-white/5 rounded-lg p-3 text-center">
                            ...
                            <div class="text-white/60 text-xs">Visibilidad</div>
                        </div>
                        <div class="bg-white/5 rounded-lg p-3 text-center">
                            ...
                            <div class="text-white/60 text-xs">Viento</div>
                        </div>
                        <div class="bg-white/5 rounded-lg p-3 text-center">
                    ...
                    <div class="bg-white/5 rounded-lg p-3">
                        <h6 class="text-white/80 text-sm font-medium mb-2">Información Adicional</h6>
                        <div class="grid grid-cols-2 gap-3 text-sm">
                            <div class="flex justify-between">
                                <span class="text-white/60">Humedad:</span>
                                <span class="text-white">{{ Math.round(hour.humidity) }}%</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-white/60">Presión:</span>
                                <span class="text-white">{{ Math.round(hour.pressure_mb) }}mb</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-white/60">Sensación:</span>
                                <span class="text-white">{{ Math.round(hour.feelslike_c) }}°C</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-white/60">Punto rocío:</span>
                                <span class="text-white">{{ Math.round(hour.dewpoint_c) }}°C</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div v-if="selectedPeriod === 'daily'" class="space-y-3">
            ...
            >
                ...
                >
                    ...
                    <div>
                        <h5 class="text-white/80 text-sm font-medium mb-2">Vista Previa por Hora</h5>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div class="bg-white/5 rounded-lg p-3 text-center">
                            ...
                            <div class="text-white/60 text-xs">Precipitación</div>
                        </div>
                        <div class="bg-white/5 rounded-lg p-3 text-center">
                            <Eye class="w-4 h-4 text-gray-400 mx-auto mb-1" />
                            <div class="text-white text-sm font-medium">
                            ...
                            <div class="text-white/60 text-xs">Humedad</div>
                        </div>
                        <div class="bg-white/5 rounded-lg p-3 text-center">
                            <Sun class="w-4 h-4 text-yellow-400 mx-auto mb-1" />
                        ...
                        <div class="bg-white/5 rounded-lg p-3 text-center">
                            ...
                            <div class="text-white/60 text-xs">Amanecer</div>
                        </div>
                    </div>

                    <!-- Astronomical info -->
                    <div class="bg-white/5 rounded-lg p-3">
                        <h6 class="text-white/80 text-sm font-medium mb-2">Datos Astronómicos</h6>
                        <div class="grid grid-cols-2 gap-3 text-sm">
                            <div class="flex justify-between">
                                <span class="text-white/60">Amanecer:</span>
                                <span class="text-white">{{ day.astro.sunrise }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-white/60">Atardecer:</span>
                                <span class="text-white">{{ day.astro.sunset }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-white/60">Salida luna:</span>
                                <span class="text-white">{{ day.astro.moonrise }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-white/60">Fase luna:</span>
