<template>
  <div class="glass-card p-6 animate-fade-in">
    <div class="flex items-center justify-between mb-6">
      <h3 class="text-xl font-semibold text-white">Weather Map</h3>
...
const getLayerDescription = () => {
  switch (selectedLayer.value) {
    case 'temp': return 'Temperature overlay with regional variations';
    case 'clouds': return 'Cloud coverage and density patterns';
    case 'precipitation': return 'Rainfall and precipitation intensity';
    case 'wind': return 'Wind patterns and speed variations';
