<template>
  ...
  >
    <div class="bg-white/10 backdrop-blur-md rounded-xl p-8 w-full max-w-md mx-4 border border-white/20">
      <div class="text-center mb-6">
        <h2 class="text-2xl font-bold text-white mb-2">Welcome to Weather Dashboard</h2>
        <p class="text-white/70">Set up your WeatherAPI key to get started with real-time weather data</p>
      </div>
      ...
      <div class="space-y-4">
        <div>
          ...
          <p class="text-white/60 text-xs mt-2">
            ...
            <a href="https://www.weatherapi.com/signup.aspx" target="_blank" class="text-blue-400 hover:text-blue-300 underline">
              weatherapi.com
            </a>
          </p>
        </div>
